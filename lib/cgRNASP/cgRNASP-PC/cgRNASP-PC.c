...
/////////////////////////////////////////////////////////
 ...
 atom_type=fopen("lib/cgRNASP/bin/cgRNASP-PC_data/8atom_type.dat","r+");
...
/////////////////////////////////////////////////////////
 ...
 potential1 = read_potential("lib/cgRNASP/bin/cgRNASP-PC_data/0-1_short-ranged.potential", intervals1);
 potential2 = read_potential("lib/cgRNASP/bin/cgRNASP-PC_data/1-2_short-ranged.potential", intervals2);
 potential3 = read_potential("lib/cgRNASP/bin/cgRNASP-PC_data/2-4_short-ranged.potential", intervals3);
 potential4 = read_potential("lib/cgRNASP/bin/cgRNASP-PC_data/long-ranged.potential", intervals4);
/////////////////////////////////////////////////////////
...
///
 ...
 energy = 1.0*energy1 + 0.6*energy2 + 1.1*energy3 + 6.2*energy4/fun(length);
 printf("%lf", energy);
// }
// fclose(FP);
/////////////////////////////////////////////////////////
